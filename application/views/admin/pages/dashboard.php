<div class="main-content">
    ...
    <div class="widget">
        <div class="widget-controls pull-right">
            <a href="index.html#" class="widget-link-remove"><i class="icon-minus-sign"></i></a>
            <a href="index.html#" class="widget-link-remove"><i class="icon-remove-sign"></i></a>
        </div>
    ...
    <div class="widget">
        ...
        <ul class="nav nav-pills">
            <li class="active"><a href="index.html#">Hour</a></li>
            <li><a href="index.html#">Day</a></li>
            <li><a href="index.html#">Month</a></li>
            <li class="hidden-xs"><a href="index.html#">Year</a></li>
        </ul>
    ...
    <div class="row">
        <div class="col-md-8">
            <ul class="nav nav-tabs">
                <li class="active"><a href="index.html#tab_pie_chart" data-toggle="tab"><i class="icon-bullseye"></i> Pie Chart</a></li>
                <li><a href="index.html#tab_bar_chart" data-toggle="tab"><i class="icon-bar-chart"></i> Bar Alert</a></li>
                <li class="hidden-md hidden-xs"><a href="index.html#tab_table" data-toggle="tab"><i class="icon-table"></i> Table</a></li>
            </ul>
        ...
        <div class="col-md-4">
            <div class="widget">
                ...
                <div class="widget-content-white padded glossed">
                    ...
                    <a href="index.html#" class="btn btn-sm btn-default">view more</a>
                </div>
            </div>
        </div>
    </div>
