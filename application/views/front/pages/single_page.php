<div id="container">
    <!--Left Part-->
    <?php $this->load->view('front/pages/sidebar'); ?>
    <!--Left End-->
    <!--Middle Part Start-->
    <div id="content">
        <div class="breadcrumb"> <a href="index.html">Home</a> &raquo; <a href="product.html#">Canon EOS 5D</a> </div>
        <h1><?php echo $product->product_name; ?></h1>
        <div class="product-info">
            <div class="left">
                <div class="image"><a href="<?php echo base_url().'assets/back/upload/high-'.$product->product_image ;?>" title="Canon EOS 5D" class="cloud-zoom colorbox" id='zoom1' rel="adjustX: 0, adjustY:0, tint:'#000000',tintOpacity:0.2, zoomWidth:360, position:'inside', showTitle:false"><img src="<?php echo base_url().'assets/back/upload/medium-'.$product->product_image ;?>" title="Canon EOS 5D" alt="Canon EOS 5D" id="image" /><span id="zoom-image"><i class="zoom_bttn"></i> Zoom</span></a></div>
                <div class="image-additional">
                    <a href="<?php echo base_url().'assets/back/upload/high-'.$product->product_image ;?>" title="Canon EOS 5D" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo base_url().'assets/back/upload/medium-'.$product->product_image ;?>' ">
                        <img src="<?php echo base_url().'assets/back/upload/medium-'.$product->product_image ;?>" width="62" title="Canon EOS 5D" alt="Canon EOS 5D" />
                    </a>
                    <?php foreach($product_images as $image){?>
                    <a href="<?php echo base_url().'assets/back/upload/high-'.$image->product_image ;?>" title="Canon EOS 5D" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo base_url().'assets/back/upload/medium-'.$image->product_image ;?>' ">
                        <img src="<?php echo base_url().'assets/back/upload/medium-'.$image->product_image ;?>" width="62" title="Canon EOS 5D" alt="Canon EOS 5D" />
                    </a>
                   <?php } ?>
                    <!--
                    <a href="<?php echo base_url().'assets/back/upload/high-'.$product->product_image ;?>" title="Canon EOS 5D" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo base_url().'assets/back/upload/small-'.$product->product_image ;?>' ">
                        <img src="<?php echo base_url();?>assets/front/image/product/canon_eos_5d_3-350x350.jpg" width="62" title="Canon EOS 5D" alt="Canon EOS 5D" />
                    </a>
                    <a href="<?php echo base_url();?>assets/front/image/product/canon_eos_5d_2-500x500.jpg" title="Canon EOS 5D" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo base_url();?>assets/front/image/product/canon_eos_5d_2-350x350.jpg' ">
                        <img src="<?php echo base_url();?>assets/front/image/product/canon_eos_5d_2-350x350.jpg" width="62" title="Canon EOS 5D" alt="Canon EOS 5D" />
                    </a>-->
                </div>
            </div>
            <div class="right">
                <div class="description"> <span>Brand:</span> <a href="product.html#"><?php echo $product->brand_name; ?></a><br />
                    <span>Product Code:</span> Product 3<br />
                    <span>Reward Points:</span> 200<br />
                    <span>Availability:</span> In Stock</div>
                <div class="price">Price: <span class="price-old">$<?php echo $product->product_previous_price; ?></span> <span class="price-new">$<?php echo $product->product_present_price; ?></span> <br />
        ...
        <div id="tabs" class="htabs"> <a href="product.html#tab-description">Description</a> <a href="product.html#tab-review">Reviews (0)</a> </div>
        ...
        <div id="tab-review" class="tab-content">
            ...
            <br />
            <br />
            <img src="http://demo.harnishdesign.net/html/polishop/index.php?route=product/product/captcha" alt="" id="captcha" /><br />
            <br />
            <div class="buttons">
                ...
                <div class="box-product">
                    <div class="flexslider" id="related_pro">
                        <ul class="slides">
                            ...
                            <li>
                                <div class="slide-inner">
                                    <div class="image"><a href="product.html"><img src="<?php echo base_url();?>assets/front/image/product/iphone_1-210x210.jpg" alt="iPhone 4s" /></a></div>
                            ...
                            <li>
                                <div class="slide-inner">
                                    <div class="image"><a href="product.html"><img src="<?php echo base_url();?>assets/front/image/product/htc_touch_hd_1-210x210.jpg" alt="iPhone 5s" /></a></div>
                            ...
                            <li>
                                <div class="slide-inner">
                                    <div class="image"><a href="product.html"><img src="<?php echo base_url();?>assets/front/image/product/reebok-men-sports-shoes-210x210.jpg" alt="Reebok Men Sports Shoes" /></a></div>
                            ...
                            <li>
                                <div class="slide-inner">
                                    <div class="image"><a href="product.html"><img src="<?php echo base_url();?>assets/front/image/product/nikon_d300_1-210x210.jpg" alt="Nikon D300" /></a></div>
